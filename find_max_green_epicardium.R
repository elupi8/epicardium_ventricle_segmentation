#merge the epicardial number of cells with the platemap file containing drug name, class, number of the experiment
...
s.dir.out.mer = "merged_green_output_2"
...
s.files.core = 'deconvolved_epic_cells(|_seg).csv'
...
output.filename = paste0("Segmentation","_of_","_epicardium_", s.exp,".csv")
...
output.filename = paste0("Merged","_Green","_Segmentation","_of_", s.exp,".csv")
fwrite(dt_epicardium, file = file.path(output.Directory, output.filename), row.names=FALSE)
